		...
		<nav class="navbar navbar-inverse" style = "background-color: white; margin-bottom: 0;">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<ul class="nav navbar-nav navbar-inverse">
					<li><a href="managerindex.php" style = "background-color: white; color: black;"><span class="glyphicon glyphicon-user" style = "color: black;"></span> My account</a></li>
					</ul>
